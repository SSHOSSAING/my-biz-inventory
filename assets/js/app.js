...
const APP = {
  ...
  renderNav() {
    ...
    const items = [
      ...
      { key: 'help',       icon: 'bi-question-circle',href: prefix + 'help.html' },
    ];
...
function injectCommonUI() {
  ...
  const helpHref  = isInPages ? 'help.html' : 'pages/help.html';
  ...
  <a href="${helpHref}" class="help-float no-print" title="Help & Guide" aria-label="Help">
