...
const T = {
  en: {
    ...
    // Finance
    expenses: 'Expenses', expense: 'Expense', addExpense: 'Add Expense',
    expenseHistory: 'Expense History', description: 'Description',
    reference: 'Reference', totalExpenses: 'Total Expenses', monthExpenses: 'Month Expenses',
    outstandingDue: 'Outstanding Due', dueCollection: 'Due Collection', collectPayment: 'Collect Payment',
    collectAmount: 'Collect Amount', alreadyPaid: 'Already Paid', remainingDue: 'Remaining Due',
    recentCollections: 'Recent Collections', cashFlow: 'Cash Flow', monthlyBreakdown: 'Monthly Breakdown',
    revenue: 'Revenue', cogs: 'Cost of Goods', grossProfit: 'Gross Profit',
    netProfit: 'Net Profit', margin: 'Margin', payFull: 'Pay Full Amount',
    bankTransfer: 'Bank Transfer', receiptNo: 'Receipt No', noOutstandingDues: 'No Outstanding Dues',
    // Investors
    partners: 'Partners', investor: 'Investor', addInvestor: 'Add Investor',
    capitalInvested: 'Capital Invested', totalCapital: 'Total Capital',
    sharePercent: 'Share %', profitShare: 'Profit Share', lossShare: 'Loss Share',
    profitDistribution: 'Profit Distribution', capitalTransaction: 'Capital Transaction',
    investment: 'Investment', withdrawal: 'Withdrawal', ledger: 'Ledger', netBalance: 'Net Balance',
    joinDate: 'Join Date', roi: 'ROI', allTime: 'All Time',
    // Help
    help: 'Help', helpGuide: 'Help Guide', userGuide: 'User Guide',
    googleSync: 'Google Sync', syncGuide: 'Sync Guide',
  },
  bn: {
    ...
    // Finance
    finance: 'আর্থিক', expenses: 'খরচ', expense: 'খরচ', addExpense: 'খরচ যোগ',
    expenseHistory: 'খরচের ইতিহাস', category: 'বিভাগ', description: 'বিবরণ',
    reference: 'রেফারেন্স', totalExpenses: 'মোট খরচ', monthExpenses: 'মাসিক খরচ',
    outstandingDue: 'বকেয়া পাওনা', dueCollection: 'বকেয়া আদায়', collectPayment: 'পেমেন্ট সংগ্রহ',
    collectAmount: 'সংগ্রহের পরিমাণ', alreadyPaid: 'পূর্বে পরিশোধিত', remainingDue: 'বাকি বকেয়া',
    recentCollections: 'সাম্প্রতিক আদায়', cashFlow: 'নগদ প্রবাহ', monthlyBreakdown: 'মাসিক বিভাজন',
    revenue: 'রাজস্ব', cogs: 'পণ্য ক্রয় মূল্য', grossProfit: 'মোট লাভ',
    netProfit: 'নিট লাভ', margin: 'মার্জিন', payFull: 'সম্পূর্ণ পরিশোধ',
    bankTransfer: 'ব্যাংক ট্রান্সফার', receiptNo: 'রসিদ নং', noOutstandingDues: 'কোনো বকেয়া নেই',
    // Investors
    investors: 'বিনিয়োগকারী', partners: 'অংশীদার', investor: 'বিনিয়োগকারী',
    addInvestor: 'বিনিয়োগকারী যোগ', editInvestor: 'সম্পাদনা', capitalInvested: 'বিনিয়োগকৃত মূলধন',
    totalCapital: 'মোট মূলধন', sharePercent: 'শেয়ার %', profitShare: 'লাভের অংশ',
    lossShare: 'ক্ষতির অংশ', profitDistribution: 'লাভ বিতরণ', capitalTransaction: 'মূলধন লেনদেন',
    investment: 'বিনিয়োগ', withdrawal: 'উত্তোলন', ledger: 'খাতা', netBalance: 'নিট ব্যালেন্স',
    joinDate: 'যোগদানের তারিখ', roi: 'ROI', allTime: 'সার্বক্ষণিক',
    // Help
    help: 'সহায়তা', helpGuide: 'সহায়িকা', userGuide: 'ব্যবহারকারী গাইড',
    googleSync: 'গুগল সিঙ্ক', syncGuide: 'সিঙ্ক গাইড',
  }
};
